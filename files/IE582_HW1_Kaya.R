  ...
  qplot(data_match2$HGAG,geom="histogram",binwidth = 0.9, main = "Home Scores", xlab = "Home Goals-Away Goals",  ylab = "Number of Games", xlim = c(-10,10), ylim = c(0,200), col = "red", fill ="red", alpha=0.3)+theme(legend.position = "none")
  ...
  hist(data_match$FTHG ,right = FALSE ,ylim=c(0,300),col="lightblue",border="blue",xlab="Home Goals",ylab = "Number of Games", main="Poisson Distribution(??=1.53)",cex.main = 1)
  pois_FTHG = dpois(c(0:8),lambda = FTHG_mean)*length(data_match$FTHG)
  lines(pois_FTHG,col="purple",lwd=3)
  
  
  # Histogram for Away Score
   hist(data_match$FTAG, right = FALSE, ylim=c(0,300),col="lightblue",border="blue",xlab="Away Goals",ylab = "Number of Games", main="Poisson Distribution(??=1.27)",cex.main = 1)
  ...
  data_match = mutate(data_match, FTR_data)
  data_match$FTR_data = ifelse(data_match$FTR == "D", 1, 0)
  data_match = mutate(data_match,Probs_norm$B365_norm_Ph_Pa)
  B365_draw_data = data_match %>% count(FTR_data,Probs_norm$B365_norm_Ph_Pa)
  B365_draw_data = filter(B365_draw_data,FTR_data == !0)
  ...
  BW_draw_data = data_match %>% count(FTR_data,Probs_norm$BW_norm_Ph_Pa)
  BW_draw_data = filter(BW_draw_data,FTR_data == !0)
  ...
  PS_draw_data = data_match %>% count(FTR_data,Probs_norm$PS_norm_Ph_Pa)
  PS_draw_data = filter(PS_draw_data,FTR_data == !0)
  ...
  IW_draw_data = data_match %>% count(FTR_data,Probs_norm$IW_norm_Ph_Pa)
  IW_draw_data = filter(IW_draw_data,FTR_data == !0)
  ...
  data_match_no_redcard = mutate(data_match_no_redcard , FTR_data)
  data_match_no_redcard$FTR_data = ifelse(data_match_no_redcard $FTR == "D", 1, 0)
  B365_draw_data_no_redcard = filter(data_match_no_redcard,FTR_data == !0)
  
  B365_draw_data_no_redcard = data_match_no_redcard  %>% count(FTR_data,Probs_norm$B365_norm_Ph_Pa)
  breaks = seq(-1,1,by = 0.2)
  ...
  data_match_no_redcard = mutate(data_match_no_redcard , FTR_data)
  data_match_no_redcard$FTR_data = ifelse(data_match_no_redcard $FTR == "D", 1, 0)
  BW_draw_data_no_redcard = filter(data_match_no_redcard,FTR_data == !0)
  
  BW_draw_data_no_redcard = data_match_no_redcard  %>% count(FTR_data,Probs_norm$BW_norm_Ph_Pa)
  breaks = seq(-1,1,by = 0.2)
  ...
  data_match_no_redcard = mutate(data_match_no_redcard , FTR_data)
  data_match_no_redcard$FTR_data = ifelse(data_match_no_redcard $FTR == "D", 1, 0)
  PS_draw_data_no_redcard = filter(data_match_no_redcard,FTR_data == !0)
  
  PS_draw_data_no_redcard = data_match_no_redcard  %>% count(FTR_data,Probs_norm$PS_norm_Ph_Pa)
  breaks = seq(-1,1,by = 0.2)
  ...
  data_match_no_redcard = mutate(data_match_no_redcard , FTR_data)
  data_match_no_redcard$FTR_data = ifelse(data_match_no_redcard $FTR == "D", 1, 0)
  IW_draw_data_no_redcard = filter(data_match_no_redcard,FTR_data == !0)
  
  IW_draw_data_no_redcard = data_match_no_redcard  %>% count(FTR_data,Probs_norm$IW_norm_Ph_Pa)
  breaks = seq(-1,1,by = 0.2)
